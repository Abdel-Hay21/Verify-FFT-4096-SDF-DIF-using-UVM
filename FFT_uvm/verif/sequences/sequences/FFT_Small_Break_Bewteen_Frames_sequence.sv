package FFT_Small_Break_Bewteen_Frames_sequence_pkg;
  ...
  class FFT_Small_Break_Bewteen_Frames_sequence extends uvm_sequence #(FFT_sequence_item);
    `uvm_object_utils(FFT_Small_Break_Bewteen_Frames_sequence)
    ...
    // Constructor
    //------------------------------------------------------------
    function new (string name = "FFT_Small_Break_Bewteen_Frames_sequence");
      super.new(name);
    endfunction
    ...
    task body;
     ...
     repeat(repeat_number) begin
       ...
       // Set the constraint mode
          ...
          sequence_item.Small_Break_Bewteen_Frames_Constraint.constraint_mode(1);
